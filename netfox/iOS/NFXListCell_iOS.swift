...
class NFXListCell: UITableViewCell {
    ...
    override func layoutSubviews() {
        ...
        statusView.frame = CGRect(x: 0, y: 0, width: 75, height: frame.height - 1)
        ...
        URLLabel.frame = CGRect(x: statusView.frame.maxX + padding, y: 0, width: frame.width - URLLabel.frame.minX - 25 - padding, height: 60)
